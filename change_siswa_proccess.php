...
if($_POST){
    ...
    if(empty($nama_siswa)){
        ...
        if(empty($password)){
            ...
            if($update){
                echo "<script>alert('Sukses update siswa');location.href='output_siswa.php';</script>";
            } else {
                echo "<script>alert('Gagal update siswa');location.href='change_siswa_ui.php?id_siswa=".$id_siswa."';</script>";
            }
        } else {
